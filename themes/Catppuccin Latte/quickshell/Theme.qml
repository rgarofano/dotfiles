...
QtObject {
    ...
    readonly property color brightGreen: "#40a02b"
    readonly property color yellow: "#df8e1d"
    readonly property color brightYellow: "#df8e1d"
    readonly property color blue: "#1e66f5"
    readonly property color brightBlue: "#1e66f5"
    readonly property color magenta: "#ea76cb"
