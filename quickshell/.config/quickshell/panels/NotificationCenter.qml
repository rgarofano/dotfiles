    ...
    LazyLoader {
        ...
        PanelWindow {
            ...
            HyprlandFocusGrab {
                ...
                windows: [root.barWindow, notificationCenter]
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: root.notificationsModel.remove(index, 1)
                        }
                        ...
                        RowLayout {
                            ...
                            Text {
                                ...
                                text: notificationCenter.timeSince(createdAt)
                    ...
                    Keys.onPressed: event => {
                        if (event.key === Qt.Key_J) {
                            ...
                            root.notificationsModel.remove(currentIndex, 1)
